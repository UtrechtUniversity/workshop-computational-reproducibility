...
Make sure you're following the instructions for the right operating system and then skip the sub-section on _Adding your SSH key to the ssh-agent_.
...
If you've set up your SSH keys alright, we can try going ahead and seeing whether you can _push_ and _pull_ from GitHub successfully.
...
Go to your terminal and type the following command, substiting the SSH clone URL you copied in the previous step after `git clone`:
