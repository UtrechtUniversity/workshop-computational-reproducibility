...
- It will help you manage ~~your code~~ most of your files.

- It is like track changes on steroids: it applies to all files in a folder.
...
# What is git?
.large-left-column[
- Version Control system written by Linus Torvalds (of Linux fame)
