...
![](images/dataworkflow.png)
Source: Hadley Wickham / tidyverse documentation
...
#### As for feedback...
This workshop is work in progress! This is a pilot and we *emphatically* want your feedback. That can be anything you can think of, but in particular:
  ...
  - If you do not know a certain word or term (or you think others may not know it): flag it! We will be adding these terms to a glossary.
...
- There's also a (tentative) schedule: scroll down to 'preparations' and click the link.
