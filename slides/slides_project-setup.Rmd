...
This is something you can fix! Use a config or metadata file, and move all references to your data here. Generate a mock metadata/config file so that your code can run regardless.
