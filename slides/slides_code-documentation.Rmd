...
- Functions
 ...
 - Code that is responsible for a specific task
 - A task can be: sorting, plotting, saving a file, transform data...
...
- in R with the testthat package
...
- Do you have difficult to interpret variables in your code
  - Rename them
- Do you have repetive parts in your code, or code you would want to reuse often
  - Make functions
