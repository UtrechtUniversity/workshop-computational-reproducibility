...
- The idea of a Notebook originates from the concept of literate programming, introduced by D. Knuth in 1984.

- Idea: describe the logic of the code in natural language and include source code at the same time.

- It can be generated in one document from the original file.

- Nowadays, literate programming has evolved into Jupyter notebooks, RMarkdown documents etc.
...
- Text (now often in Markdown, LaTeX or plain text), in 'text chunks'
- Code (Python, R ...), in 'code chunks'

All chunks can be run at the same time
- Text chunks will be rendered and shown
- Code chunks will be executed, and show:
  - their code (unless hidden)
  - their ouput (if any)
...
- Some code editors/Integrated Development Environments can run notebooks:
  - Pycharm
  - Rstudio
  - Visual studio
  - ...
...
(and perhaps you have a notebook you want to show?)