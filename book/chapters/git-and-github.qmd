...
To authenticate with the GitHub server we will set up a so-called [SSH key pair](https://carpentries-incubator.github.io/hpc-intro/11-connecting.html#secure-connections)
