...
While comments explain pieces of code, docstrings describe interfaces: functions, classes, and modules that users interact with.

A docstring is a special multiline string (""" ... """) placed immediately after a definition.
It is automatically available through help(), IDE tooltips, and documentation generators like Sphinx.
...
Comments and docstrings tell you why and what it does.
...
## Presenter slides
- [HTML](../slides/sslides_code-documentation.qmd)
