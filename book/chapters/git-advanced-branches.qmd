...
![](../images/github_figures_screenshots/git-collaborative-branches.svg){width=700 fig-align="center"}
...
In the above examples we only added new files or extended contents of files. So it was easy to "merge" the files of two branches.

Assume you are extending a file containing code with a new function and your collaborator extends the file with another function, Git will detect that those lines are both new and will reject the merge or push.
...
Git highlights the lines which cause the conflict and also gives information which version of the lines come from which Pull Request. You can now edit the file, mark it as resolved and commit it by clicking "Commit merge".
