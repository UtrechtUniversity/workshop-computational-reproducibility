...
Since we only had one branch, the "main" branch, the new branch will automatically created from the main branch. Once you have more than one branch, you can select from which branch you would like to create the new one.
