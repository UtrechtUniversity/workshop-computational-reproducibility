...
Alternatively, you can host reproducible environments online with platforms such as [**Binder**](https://mybinder.org), [**CodeOcean**](https://codeocean.com) or [**Colab**](https://colab.research.google.com). How far you go is a trade-off between time investment and ease of use, and depends on your goals.
...
[`uv`](https://docs.astral.sh/uv/) is a fast, Rust-based package and project manager for Python. It is relatively new, increasingly popular and our recommendation.
...
```
::: {.callout-note}
If you are working on windows, check the [installation instructions](https://docs.astral.sh/uv/getting-started/installation/)
:::
...
[`conda`](https://docs.conda.io/) has been around for years and similar to `uv`, it helps you create and switch between isolated environments.
...
[`renv`](https://blog.rstudio.com/2019/11/06/renv-project-environments-for-r/) is an R package that manages environments for R projects. It allows you to save and restore the exact versions of your R packages, and it works well with the [projects feature of RStudio](https://support.posit.co/hc/en-us/articles/200526207-Using-RStudio-Projects).
...
2. **If using Python:**
   ...
   * Generate an environment and store the `pyproject.toml` (or `environment.yml`) in your project root.
...
```{=html}
<iframe class="slide-deck" src="../slides/slides_dependencies.html" title="Dependencies" width="960" height="540">
</iframe>
```
