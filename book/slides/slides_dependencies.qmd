...
- [Here is an example](https://github.com/ericmjl/essays-on-data-science/blob/master/environment.yml). Search for [more on GitHub](https://github.com/search?q=path%3A**%2Fenvironment.yml+language%3AYAML+language%3AYAML&type=code).
...
- [Here is an example](https://github.com/Curly-Mo/musinformatics/blob/552494f8e6aec9810b1027e725bbf24a6784b369/requirements.txt). Search for [more on GitHub](https://github.com/search?q=path%3A**%2Frequirements.txt&type=code).
